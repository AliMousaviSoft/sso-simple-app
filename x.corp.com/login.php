...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const callbackName = 'tokenCallback_' + Math.random().toString(36).substr(2, 9);
            ...
            connectBtn.addEventListener('click', function() {
                ...
                script.src = `http://sso.corp.com:9001/jsonp.php?callback=${callbackName}`;
